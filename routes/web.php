...
Route::prefix('admin')->middleware(['auth', 'rol:admin'])->group(function() {
    ...
    Route::get('TRIAGES', function() { return view('atencion-medica.triage'); });
    ...
    Route::get('ConsultarEspecialidades',function(){ return view('specialties.index'); });
    Route::get('RegistroMedico', function (){ return view('medicos.medicocreate'); });
    Route::get('perfil',function(){ return view('configuracion-sistema.perfil'); });
    Route::get('cambiar-contraseña', function () { return view('configuracion-sistema.cambiar-contraseña'); });
    Route::get('Sucursales',function(){ return view('ubicaciones.index'); });
    Route::get('Agenda',function(){ return view('citas.index'); });
